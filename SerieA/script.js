...
getApiKey().then(apiKey => {
    const url_ligamatches = 'https://api-football-v1.p.rapidapi.com/v3/fixtures?league=135&season=2023&from=2023-08-01&to=2024-05-31';
    ...
    async function fetchNewsData() {
        try {
            const response = await fetch('https://transfermarkt-db.p.rapidapi.com/v1/competitions/news?competition_id=IT1&locale=US', {
                method: 'GET',
                headers: {
                    'X-RapidAPI-Key': apiKey,
    ...
    const url_ligagoals = 'https://api-football-v1.p.rapidapi.com/v3/players/topscorers?league=135&season=2023';
    ...
    const url_ligaassisters = 'https://api-football-v1.p.rapidapi.com/v3/players/topassists?league=135&season=2023';
    ...
    const url_ligastandings = 'https://api-football-v1.p.rapidapi.com/v3/standings?season=2023&league=135';
